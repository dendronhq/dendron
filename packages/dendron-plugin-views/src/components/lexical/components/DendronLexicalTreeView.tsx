...
import { $isTwoStateNode } from "../nodes/TwoStateNode";
...
function printDendronProperties(nodeOrSelection: LexicalNode) {
  if ($isTwoStateNode(nodeOrSelection)) {
    return `formattedText: "${nodeOrSelection.__formattedText}", rawText: "${nodeOrSelection.__rawText}"`;
  }
}

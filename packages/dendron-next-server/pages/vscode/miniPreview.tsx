import { DEngineClient, NoteProps, NoteUtils, VaultUtils } from "@dendronhq/common-all";
import { engineSlice, WebEngine } from "@dendronhq/common-frontend";
import { useRouter } from "next/router";
import React from "react";

const convertMd = ({engine, fname, vaultName}: {engine: DEngineClient, fname: string, vaultName: string}) => {
...
export default function MiniPreview({
  ...
  engine: engineSlice.EngineState;
    ...
    return <>Fname: {router.query.fname}, Body: {note.body}</>
}
...
utils_1.LSPUtils.instance(connection);
...
connection.onInitialized(async () => {
    ...
    const wsFolders = await utils_1.LSPUtils.wsFolders();
    if (wsFolders && wsFolders[0]) {
        const uri = vscode_uri_1.URI.parse(wsFolders[0].uri);
        engine_server_1.DendronEngine.getOrCreateEngine({ root: uri.fsPath, forceNew: true });

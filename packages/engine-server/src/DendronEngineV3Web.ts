...
export class DendronEngineV3Web /*implements DEngine*/ {
  ...
  static instance({ wsRoot }: { wsRoot: string }) {
    if (!DendronEngineV3Web._instance) {
      DendronEngineV3Web._instance = DendronEngineV3Web.create({ wsRoot });
    }
    return DendronEngineV3Web._instance;
  }

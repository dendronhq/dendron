...
export namespace Prisma {
  ...
  */
  ...
  export type notesGetPayload<
    ...
    P extends keyof notes ? notes[P] : never
  } 
    : notes
  : notes
  ...
  export interface notesDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     * 
     * // Only select the `fname`
     * const notesWithFnameOnly = await prisma.notes.findMany({ select: { fname: true } })
     * 
    **/
  ...
  export type notesWhereInput = {
    ...
    vault?: StringNullableFilter | string | null
  ...
  export type notesScalarWhereWithAggregatesInput = {
    ...
    vault?: StringNullableWithAggregatesFilter | string | null
  ...
  export type notesUpdateInput = {
    ...
    vault?: NullableStringFieldUpdateOperationsInput | string | null
